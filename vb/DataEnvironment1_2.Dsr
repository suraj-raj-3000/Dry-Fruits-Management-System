...
Begin {C0E45035-5775-11D0-B388-00A0C9055D8E} DataEnvironment1 
   ...
   _ExtentY        =   10663
   FolderFlags     =   1
   TypeLibGuid     =   "{95925956-8EE3-4299-B7FD-ED931D15A48F}"
   TypeInfoGuid    =   "{9ABFEEA5-7B76-4FEB-85A9-1F0E89C35C9B}"
   TypeInfoCookie  =   0
   Version         =   4
   NumConnections  =   1
   ...
   BeginProperty Recordset1 
      CommandName     =   "cust_orderno"
      CommDispId      =   1002
      RsDispId        =   1006
      CommandText     =   "select * from customer_order_detail cod,customer_ordered_product cop where cod.order_number=? and cop.ord_no=?"
