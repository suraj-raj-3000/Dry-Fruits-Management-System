VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} s_all_report 
   Bindings        =   "s_all_report.dsx":0000
   Caption         =   "DataReport4"
   ClientHeight    =   8595
   ClientLeft      =   120
   ClientTop       =   465
   ...
   EndProperty
End
Attribute VB_Name = "s_all_report"
